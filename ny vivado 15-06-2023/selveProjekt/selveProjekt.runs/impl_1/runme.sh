...
HD_PWD='C:/Users/abdul/OneDrive/Skrivebord/ny vivado 15-06-2023/selveProjekt/selveProjekt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LC3Zybo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LC3Zybo_top.tcl -notrace
